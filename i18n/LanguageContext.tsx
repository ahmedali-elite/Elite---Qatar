...
const enTranslations = {
  ...
  "summary": {
    ...
    "challengesAnalysis": "Challenges vs. Goals Analysis",
    "budget": "Budget Allocation",
    "unlockTitle": "Unlock Detailed Insights",
    "unlockSubtitle": "This advanced analysis is available for our clients.",
    "unlockButton": "Contact Us to Reveal",
    "noBudgetData": "No budget data to display.",
...
const arTranslations = {
  ...
  "summary": {
    ...
    "challengesAnalysis": "تحليل التحديات مقابل الأهداف",
    "budget": "توزيع الميزانية",
    "unlockTitle": "اكتشف رؤى تفصيلية",
    "unlockSubtitle": "هذا التحليل المتقدم متاح لعملائنا.",
    "unlockButton": "تواصل معنا للكشف",
    "noBudgetData": "لا توجد بيانات ميزانية لعرضها.",
